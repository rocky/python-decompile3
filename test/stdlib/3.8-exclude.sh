SKIP_TESTS=(
    ...
    [test__locale-3.8.py]=1 # parse error
    ...
    [test_named_expression.spy]=1 # parse error
    ...
    [test_py_expat.py]=1 # parse error
    ...
    [test_thread_import.py]=1 # parse error
    [test_threading.py]=1 #
    ...
    [test_unvielines.py]=1 # parse error
    ...
    [test_xxsubinterpreters.py]=1 # parse error

    [test_yield_from.py]=1 # parse error

    [test_zipapp_from.py]=1 # parse error
    [test_zipfile.py]=1 # it fails on its own
    [test_zipfile64.py]=1 #
)
# 262 test files, Elapsed time about 20 minutes
