SKIP_TESTS=(
    [test_aifc.py]=1 # FIXME: formatting rule needs fixing
    [test_asynchat.py]=1 # FIXME formatting rule needs fixing
    [test_binop.py]=1  # FIXME formatting rule needs fixing
    [test_builtin.py]=1  # FIXME formatting rule needs fixing
    [test_bytes.py]=1  # FIXME formatting rule needs fixing
    [test_cmd_line_script.py]=1 # FIXME formatting rule needs fixing
    [test_contextlib.py]=1 # FIXME formatting rule needs fixing
    [test_configparser.py]=1 # FIXME formatting rule needs fixing
    [test_compare.py]=1 # FIXME formatting rule needs fixing
    [test_compile.py]=1 # FIXME formatting rule needs fixing
    ...
    [test_baseexception.py]=1  # control flow probably
