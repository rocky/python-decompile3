SKIP_TESTS=(
    [test_abc.py]=1   # FIXME works in master
    [test_ast.py]=1   # FIXME works in master
    [test_bdb.py]=1   # FIXME works in master
    [test_builtin.py]=1   # FIXME works in master
    [test_calendar.py]=1   # FIXME works in master
    [test_context.py]=1   # FIXME works in master
    [test_crypt.py]=1   # FIXME works in master
    [test_dictviews.py]=1   # FIXME works in master
    [test_finalization.py]=1   # FIXME works in master
    [test_float.py]=1  # FIXME works in master
    [test_format.py]=1  # FIXME works in master
    [test_fractions.py]=1  # FIXME works in master
    [test___future__.py]=1  # FIXME works in master
    [test_hashlib.py]=1  # FIXME works in master
    [test_locale.py]=1  # FIXME works in master
    [test_minidom.py]=1  # FIXME works in master
    [test_pathlib.py]=1  # FIXME works in master
    ...
    [test_py_compile.py]=1  # FIXME works in master
    [test_sax.py]=1  # FIXME works in master
    [test_set.py]=1  # FIXME works in master
    [test_sort.py]=1  # FIXME works in master
    [test_sysconfig.py]=1  # FIXME works in master
    [test_sys_setprofile.py]=1  # FIXME works in master
    [test_tempfile.py]=1  # FIXME works in master
    [test_time.py]=1  # FIXME works in master
    [test_weakset.py]=1  # FIXME works in master
    [test_xml_etree.py]=1  # FIXME works in master
